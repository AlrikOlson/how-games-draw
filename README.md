...
Everything is plain HTML and canvas. No framework, nothing loads from anywhere except the two fonts. The lessons in `pages/` open straight from disk. `UNCERTAIN.md` lists every number or citation that was written from memory.
